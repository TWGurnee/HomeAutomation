...
class AddItemIntentHandler(AbstractRequestHandler):
    ...
    def handle(self, handler_input):
        # type: (HandlerInput) -> Response
        speak_output = "{item} added to your shopping list."
...
class RemoveItemIntentHandler(AbstractRequestHandler):
    """Handler for RemoveItem Intent."""
    def can_handle(self, handler_input):
        # type: (HandlerInput) -> bool
        return ask_utils.is_intent_name("RenoveItemIntent")(handler_input)

    def handle(self, handler_input):
        # type: (HandlerInput) -> Response
        speak_output = "{item} removed from your shopping list."
...
class SendEmailIntentHandler(AbstractRequestHandler):
    ...
    def handle(self, handler_input):
        # type: (HandlerInput) -> Response
        speak_output = "Your shopping list has been sent to your email inbox."
